import { IDeletePartnerConfirmationModalProps } from "./index";
import { Modal, Button } from "../../../../components/index";
import { useState } from "react";
import { toast } from "react-toastify";

export const PartnerConfirmationModal: React.FC<
  IDeletePartnerConfirmationModalProps
> = ({ isOpen, onClose, onConfirm, partner, children = "" }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      toast.error(
        `Failed to delete partner "${partner.name}". Please try again.`
      );
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="no-scrollbar relative w-full max-w-[500px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-8">
        <div className="px-2">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Are you sure you want to delete the service "{partner.name}"? This
